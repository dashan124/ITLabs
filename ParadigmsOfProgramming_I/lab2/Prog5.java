...
public static void main(String[] args){
	...
	int n=input.nextInt();
	System.out.println("enter the coeficients of each variable for each eqaution:");
	...
	System.out.println("the invert is :");
	for(int i=0;i<n;i++){
		for(int j=0;j<n;j++){
			System.out.print(inveted_mat[i][j]+" ");
		}
		System.out.println();
	}
...
public static double[][] invert(double a[][]){
	...
	//transform the matrix b[i][j]in to n uppper triangle
	 gaussian(a, index);
