...
t=Avl()
t.insert(t.head.left,1000)
print("   %s seconds",time.time()-start_time)
t.insert(t.head.left,10000)
t.insert(t.head.left,100000)
t.search(t.head.left,1000)
t.search(t.head.left,10000)
t.search(t.head.left,100000)
t.delete(t.head.left,1000)
t.delete(t.head.left,10000)
